                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('estoqueCreate')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="categoria" id="exampleInputPassword1" placeholder="Digite a categoria">
                                </div>
